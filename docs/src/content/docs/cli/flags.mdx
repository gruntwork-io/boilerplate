...
| `--parallelism` | Number of CPUs | Maximum number of [`for_each`](/docs/configuration/dependencies/#for_each) dependency iterations to process concurrently. Use `--parallelism=1` to disable concurrency |
