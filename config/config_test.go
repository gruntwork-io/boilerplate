...
func TestLoadBoilerplateConfigFullConfig(t *testing.T) {
	...
	actual, err := LoadBoilerplateConfig(logging.Discard(), vfs.NewOSFS(), testutil.CreateTestOptions("../test-fixtures/config-test/full-config"))
	expected := &BoilerplateConfig{
...
func TestLoadBoilerplateConfigNoConfig(t *testing.T) {
	...
	_, err := LoadBoilerplateConfig(logging.Discard(), vfs.NewOSFS(), testutil.CreateTestOptions(templateFolder))
...
func TestLoadBoilerplateConfigNoConfigIgnore(t *testing.T) {
	...
	actual, err := LoadBoilerplateConfig(logging.Discard(), vfs.NewOSFS(), opts)
	expected := &BoilerplateConfig{}
...
func TestLoadBoilerplateConfigInvalidConfig(t *testing.T) {
	...
	_, err := LoadBoilerplateConfig(logging.Discard(), vfs.NewOSFS(), testutil.CreateTestOptions("../test-fixtures/config-test/invalid-config"))
